...
<head>
    ...
    <link href="{{ asset('css/userhomecss/userhomecss.css') }}" rel="stylesheet">
    <!-- Font Awesome Link -->
...
<body>
    ...
    <div class="full-page">
        <!-- <div class="acca-intro-box">
            <div class="acca-intro">
            ...
            <div class="paper-nav-list">
                <nav>
                    <ul class="ul-list">
                        ...
                        <li><a class="f2" href="">Comming soon</a></li>
            ...
            <div class="left-content">
                <div class="notes-download">
                    ...
                    <div class="notes-file">
                        @forelse ($Download as $download)
                          <div class="file-box">
                            <h4><a href="{{route('download.file',['id'=>$download->id])}}">{{$download->title}}</a></h4>
                          </div>
                       @empty
                       No book
                    @endforelse
                ...
                <div class="right-content-section">
                    @forelse ($Document as $document)
                        <div class="section1">
                           ...
                           <a href="{{route('documentview',['id'=>$document->id])}}"><h3>{{$document->title}}</h3></a>
