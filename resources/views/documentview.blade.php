...
<head>
    ...
    <link href="{{ asset('css/documentsviewcss/documentsviewcss.css') }}" rel="stylesheet">
    <!-- Font Awesome Link -->
            ...
            <div class="right-content">
                <div class="right-content-section">
                        ...
                        <div class="section1">
                           ...
                           {{-- <iframe src="{{ asset('storage/' . $Document->document) }}" frameborder="1" style="width:100%;min-height:800px;"></iframe> --}}
