    ...
    <div class="full-page">
      @include('message.message_block')
        <div class="post-achievement">
            <div class="form">
                <form class="post-achievement-form" action="{{ route('document.store') }}" method="POST" enctype="multipart/form-data">
                  {{ csrf_field() }}
                    <h2>Add Document -</h2>
                    <div class="post-achievement-title">
                        <input type="text" name="title" placeholder="Document Title Here ...">
                    </div>
                    <div class="post-achievement-detail">
                        <textarea name="detail" placeholder="Document details here ..."></textarea>
                    </div>
                    <div class="post-achievement-icon">
                        <input type="file" name="document">
                        <h3>Only pdf support</h3>
                    </div>
